...
namespace parkify.Service.Migrations
{
    ...
    [Migration("20260616225844_ReservationModifiedByAndCheckInBy")]
    partial class ReservationModifiedByAndCheckInBy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("parkify.Service.Database.Reservation", b =>
                {
                    ...
                    b.Property<decimal>("PaymentAmountPaid")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasIndex("UserId", "ReservationStart", "ReservationEnd", "Status");
            ...
            modelBuilder.Entity("parkify.Service.Database.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("parkify.Service.Database.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("parkify.Service.Database.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("parkify.Service.Database.ParkingZone", b =>
                {
                    b.HasOne("parkify.Service.Database.City", "City")
            ...
            modelBuilder.Entity("parkify.Service.Database.Payment", b =>
                {
                    ...
                    b.HasOne("parkify.Service.Database.Wallet", "Wallet")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("parkify.Service.Database.Preference", b =>
                {
                    b.HasOne("parkify.Service.Database.ParkingZone", "FavoriteParkingZone")
                        .WithMany("FavoriteByPreferences")
                        .HasForeignKey("FavoriteParkingZoneId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("parkify.Service.Database.City", "PreferredCity")
            ...
            modelBuilder.Entity("parkify.Service.Database.Wallet", b =>
                {
                    b.HasOne("parkify.Service.Database.User", "User")
                        .WithOne("Wallet")
                        .HasForeignKey("parkify.Service.Database.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("parkify.Service.Database.ParkingZone", b =>
                {
                    b.Navigation("FavoriteByPreferences");
